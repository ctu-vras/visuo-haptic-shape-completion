...
%
% IDX = knnsearch(Q) or IDX = knnsearch(Q,[],K) does the search parfor R = Q.
%
% Rationality
% Linear KNN search is the simplest appraoch of KNN. The search is based on
% calculation of all distances. Thereparfore, it is normally believed only
% suitable parfor small data sets. However, other advanced approaches, such as
...
% aceeleration of MATLAB. Numerical example shows that its perparformance is
...
fprintf('CPU time parfor knnsearch = %g\n',t1-t0);
fprintf('CPU time parfor delaunay  = %g\n',t2-t1);
%}
